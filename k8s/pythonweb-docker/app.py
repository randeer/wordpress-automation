...
def submit():
    ...
    try:
        ...
        return 'Form submitted successfully! Redirecting to the your created wordpress site...<script>setTimeout(function(){{window.location.href = "/success";}}, 60000);</script>'
    except mysql.connector.Error as err:
        return f'Database error: {err}'

@app.route('/success')
def success():
    return redirect(f'http://{request.form["domainname"]}')
